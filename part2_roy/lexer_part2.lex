...
%%
 ...
 /* For each token we match, the semantic value that is passed to Bison is the new leaf node we create for it */
 /*   and the returned value is the code of the toekn we found */
...
{str}                   { yytext[yyleng-1] = '\0'; yylval = makeNode("str",yytext+1,NULL); return STR; }
